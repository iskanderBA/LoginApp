...
import com.example.loginapp.adapters.AdapterPdfAdmin;
...
import static com.example.loginapp.Constants.MAX_BYTES_PDF;
    ...
    String TAG = "PDF_LOAD_SINGLE_TAG";
        ...
        ref.getBytes(MAX_BYTES_PDF).addOnSuccessListener(new OnSuccessListener<byte[]>() {
            ...
            public void onSuccess(byte[] bytes) {
               ...
               pdfView.fromBytes(bytes).pages(0)//only show first page
                        .spacing(0)
