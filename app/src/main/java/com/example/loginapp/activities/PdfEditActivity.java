...
import com.example.loginapp.databinding.ActivityPdfEditBinding;
...
public class PdfEditActivity extends AppCompatActivity {
    ...
    private void updatePdf() {
        ...
        progressDialog.setMessage("Upadating book info..");
        ...
        ref.child(bookId)
            ...
            public void onSuccess(Void unused) {
                ...
                progressDialog.dismiss();
                Toast.makeText(PdfEditActivity.this, "Book info updated", Toast.LENGTH_LONG).show();
