...
import com.example.loginapp.databinding.ActivityPdfAddBinding;
...
public class PdfAddActivity extends AppCompatActivity {
    ...
    private void validateData() {
        ...
        if (TextUtils.isEmpty(title)){
            ...
            Toast.makeText(this, " pick a category!!", Toast.LENGTH_LONG).show();
        }
        else if (pdfUri==null){
    ...
    private void uploadPdfInfoToDb(String uploadPdfUrl, long timestamp) {
        ...
        ref.child(""+timestamp)
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(PdfAddActivity.this, "  failed to upload to db due to"+e.getMessage(), Toast.LENGTH_LONG).show();
    ...
    private void loadPdfCategories() {
        Log.d(TAG,"loadPdfCategpries: loading pdf pick intent");
